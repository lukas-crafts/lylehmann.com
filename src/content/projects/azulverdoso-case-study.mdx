...
image: ../../assets/images/Azulverdoso-blog-hero.png
ogImage: ../../assets/images/Azulverdoso-blog-hero.png
cover: ../../assets/images/Azulverdoso-blog-hero.png
category: 'Case Study'
tags:
  - UI Design
  - Web Design
  - E-Commerce
metadata:
  canonical: https://www.lylehmann.com/portfolio/azulverdoso-case-study
---

import DListItem from '../../components/ui/DListItem.astro';
import ToggleTheme from '../../components/common/ToggleTheme.astro';
import Hero from '../../components/widgets/Hero-blogPost.astro';
import HeroImage from '../../assets/images/Azulverdoso-blog-hero.png';
import ColorImage from '../../assets/images/Azulverdoso-colors.jpg';
...
<Steps
  ...
  image={{
    src: 'https://images.pexels.com/photos/8066102/pexels-photo-8066102.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    alt: 'Putting of Clear Coat on a Pot',
  }}
  items={[
    {
      title: 'Research',
