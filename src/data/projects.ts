...
export const projects: Project[] = [
  {
    ...
    title: "Azulverdoso",
    description:
      "A website that shows handmade ceramics and makes it easy for people to see and buy them.",
  ...
  },
  {
    ...
    hero: {
      ...
      image: {
        src: "/assets/images/BrushingBuddy-home-hero.png",
        alt: "BrushBuddy app showing gamification and music integration features",
      },
    },
    features: [
      {
    ...
    insights: [
      {
        ...
        description: "Key takeaways from the BrushBuddy development project:",
        icon: "tabler:bulb",
      },
      {
  ...
  },
  {
    ...
    description:
      "A website for a museum that shows fashion history in a fun and simple way.",
    ...
    hero: {
      ...
      subtitle:
        "A comprehensive exploration of digital solutions for museum visitor experiences",
      image: {
        src: "/assets/images/FHM-home-hero.png",
        alt: "A comprehensive exploration of digital solutions for museum visitor experiences",
      },
    },
    features: [
      {
        ...
        description:
          "Museums often overwhelm visitors with too much information",
        icon: "tabler:info-circle",
      },
      {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Brainstormed and created low-fidelity wireframes together",
        icon: "tabler:brain",
      },
      {
    ...
    designElements: [
      {
        ...
        description:
          "Personalized, portable museum guide for individual visitors",
        icon: "tabler:device-mobile",
      },
      {
        title: "Museum Touchscreen Version",
        description:
          "Interactive in-museum digital interface for exhibit exploration",
    ...
    insights: [
      {
        ...
        description:
          "To explore different design solutions and learn from diverse approaches to the same problem.",
        icon: "tabler:chevron-right",
      },
      {
        title: "What was the biggest design challenge?",
        description:
          "Creating a digital experience that enhances, not replaces, the physical museum visit.",
        icon: "tabler:chevron-right",
      },
      {
        title: "What did we learn?",
        description:
          "The importance of user-centered design and collaborative problem-solving.",
        icon: "tabler:chevron-right",
      },
    ],
  },
  {
    ...
    title: "Metta Cafe",
    description:
      "A website for a café in Munich where you can eat, relax, and do yoga. Easy to use for everyone.",
    ...
    hero: {
      ...
      subtitle:
        "How we transformed a unique Munich venue combining café, bakery and yoga into an engaging digital experience through thoughtful UX design.",
      image: {
        src: "/assets/images/METTA-home-hero.png",
        alt: "Metta Cafe digital transformation hero",
      },
    },
    features: [
      {
    ...
    steps: [
      {
        title: "Empathize",
        description:
          "Conducted interviews with yoga practitioners and café regulars. Analyzed pain points in accessing venue information and services.",
        icon: "tabler:users",
      },
      {
        title: "Define",
        description:
          "Created personas including The Health-Conscious Professional and The Yoga Enthusiast. Mapped user journeys across different services.",
        icon: "tabler:user",
      },
      {
        title: "Ideate",
        description:
          "Integrated booking system for yoga classes, dietary filter system for menu items, and mobile-first design approach.",
        icon: "tabler:bulb",
      },
      {
        title: "Prototype & Test",
        description:
          "Created interactive prototypes for both web and mobile. Conducted usability testing with target user groups.",
        icon: "tabler:device-desktop",
      },
    ],
    designElements: [
      {
        ...
        description:
          "Created a seamless connection between the three core offerings - café, bakery, and yoga studio - while maintaining distinct identity for each service.",
        icon: "tabler:link",
      },
      {
    ...
    insights: [
      {
        title:
          "What was the biggest challenge in designing for multiple services?",
        description:
  ...
  },
  {
    ...
    title: "Lieferando",
    description:
      "A mobile app that helps you order food from your favorite restaurants. Easy to use for everyone.",
    ...
    hero: {
      ...
      subtitle:
        "Creating a more intuitive and streamlined ordering process for a food delivery platform",
      image: {
        src: "/assets/images/Lieferando-home-hero.png",
    ...
    features: [
      {
        ...
        description:
          "Ensuring the website is fully functional and visually appealing across all device sizes.",
        icon: "tabler:device-laptop",
      },
      {
        title: "User Feedback Integration",
        description:
          "Developing a system to effectively collect and incorporate user feedback.",
        icon: "tabler:message-2",
      },
      {
        title: "Visual Appeal",
        description:
          "Creating a more visually appealing and engaging interface to increase user retention.",
        icon: "tabler:eye",
      },
    ],
    stats: [
    ...
    steps: [
      {
        title: "Research",
        description:
          "Studied Lieferando's existing platform, user research, and competitor websites to understand user needs and design trends.",
        icon: "tabler:search",
      },
      {
        title: "Ideation",
        description:
          "Created mood boards and sketches to define the website's visual style and user flow. Focused on a modern, minimalist design with a strong emphasis on accessibility and usability.",
        icon: "tabler:bulb",
      },
      {
        title: "Prototyping",
      ...
      },
      {
        title: "Testing",
        description:
          "Gathered feedback from Lieferando staff and users to iterate on the design and content based on user feedback.",
        icon: "tabler:test-pipe",
      },
    ],
    designElements: [
      {
        ...
        description:
          "Utilized a modern, minimalist design language to create a clean and professional look.",
        icon: "tabler:palette",
      },
      {
        title: "Responsive Grid System",
        description:
          "Implemented a responsive grid system to ensure content is displayed optimally across all device sizes.",
        icon: "tabler:layout-grid",
      },
      {
        title: "Interactive Galleries",
        description:
          "Designed interactive image galleries with smooth transitions and zoom capabilities.",
        icon: "tabler:photo",
      },
      {
        title: "Filter and Search",
        description:
          "Implemented advanced filtering and search functionality to help users find specific items easily.",
        icon: "tabler:search",
      },
      {
        title: "Accessible Design",
        description:
          "Focused on accessibility, ensuring that all features are usable by people with disabilities.",
        icon: "tabler:wheelchair",
      },
      {
        title: "User Feedback Integration",
        description:
          "Designed a system to effectively collect and incorporate user feedback, including a dedicated feedback section and a streamlined feedback form.",
        icon: "tabler:message-2",
      },
    ],
    outcomes: [
    ...
    insights: [
      {
        ...
        description:
          "Understanding and incorporating user feedback is crucial in creating a successful and engaging app. User preferences and comfort are paramount.",
        icon: "tabler:user-check",
      },
      {
        title: "Cross-Platform Development",
        description:
          "Gained experience in developing for multiple platforms (iOS, Android) and ensuring consistent user experience across devices.",
        icon: "tabler:device-laptop",
      },
      {
        title: "Adobe XD Proficiency",
        description:
          "Practical experience in using Adobe XD for end-to-end UX/UI design, from wireframing to high-fidelity prototypes.",
        icon: "tabler:brand-adobe-xd",
      },
      {
        title: "Brand Representation",
        description:
          "Learned how to effectively translate a brand's unique aesthetic and story into a digital format, preserving its essence while embracing modern e-commerce capabilities.",
        icon: "tabler:brush",
      },
    ],
    faqs: [
      {
        title: "What is the main purpose of the Lieferando redesign?",
        description:
          "The main purpose of the Lieferando redesign is to create a more intuitive and streamlined ordering process for a food delivery platform, improving user experience and increasing conversion rates.",
      },
      {
        title: "Is the website and mobile app accessible?",
        description:
          "Yes, both the website and mobile app are designed with accessibility in mind. They include features like alt text for images, keyboard navigation, and ARIA labels for screen readers.",
      },
      {
        title: "Can users order food and beverages online?",
        description:
          "Yes, users can easily order food and beverages online through the website or mobile app. The platform supports various payment methods and includes a secure checkout process.",
      },
      {
        title: "How is the feedback integrated?",
        description:
          "The feedback is integrated through a dedicated feedback section and a streamlined feedback form. Users can provide suggestions, report issues, or share their overall experience.",
      },
    ],
  },
  {
    ...
    title: "FocusBuddy",
    description:
      "A Mac app that helps you stay focused and get things done. Great for anyone who finds it hard to concentrate.",
    ...
    hero: {
      ...
      image: {
        src: "/assets/images/FocusBuddy-home-hero.png",
        alt: "Screenshot of FocusBuddy macOS app UI",
      },
    },
    features: [
      {
  ...
  },
  {
    ...
    title: "Julio",
    description:
      "A website for a musician to share music and connect with fans. Simple and fun to use.",
    image: "/assets/images/Julio-home-hero.png",
    tags: ["Web", "Music", "Artist", "Design"],
    hero: {
      title: "Drumming Up Success - Julio's Digital Makeover",
      subtitle:
        "How a talented Cuban percussionist and teacher set the stage for an impactful digital presence with a strategic website concept.",
      image: {
        src: "/assets/images/Julio-home-hero.png",
        alt: "Julio digital makeover hero",
      },
    },
    features: [
      {
        title: "No Online Presence",
        description: "Julio lacked a website and cohesive digital strategy.",
        icon: "tabler:world-off",
      },
      {
        title: "Dual Audience Challenge",
        description:
          "Needed to target both music students and performance clients.",
        icon: "tabler:users",
      },
      {
        title: "Brand Clarity",
        description:
          "Required clear messaging to position Julio as both teacher and performer.",
        icon: "tabler:message",
      },
    ],
    stats: [
    ...
    steps: [
      {
        title: "Analyse",
        description:
          "Conducted market and competitor analysis, defined target audiences, and performed SWOT analysis.",
        icon: "tabler:search",
      },
      {
        title: "Strategy",
        description:
          "Developed a roadmap to position Julio as an expert in Afro-Cuban percussion, defined goals, personas, and creative vision.",
        icon: "tabler:bulb",
      },
      {
        title: "Operational Concepts",
        description:
          "Outlined actionable steps: website structure, backlink strategies, testimonials, events calendar, press kit, FAQs, pricing, and course descriptions.",
        icon: "tabler:checklist",
      },
      {
        title: "Planning & Evaluation",
        description:
          "Created a detailed timeline, cost plan, and KPIs for monitoring success.",
        icon: "tabler:calendar-stats",
      },
    ],
    designElements: [
      {
        title: "Cuban Heritage Emphasis",
        description:
          "Core messaging and visuals aligned with Julio's Cuban roots.",
        icon: "tabler:music",
      },
      {
        title: "Responsive Website Structure",
        description:
          "Blueprint for a site with distinct sections for lessons and performances.",
        icon: "tabler:layout",
      },
      {
        title: "Content Strategy",
        description:
          "Strategic content for both student and performance audiences.",
        icon: "tabler:notes",
      },
    ],
    outcomes: [
    ...
    insights: [
      {
        ...
        description:
          "Balancing content for two distinct audiences: students and performance clients.",
        icon: "tabler:scale",
      },
      {
        title: "Intercultural Communication",
        description:
          "Collaboration required translation and cultural sensitivity.",
        icon: "tabler:language",
      },
      {
        title: "Accessibility Improvements",
        description:
          "Future improvements include screen reader compatibility, color contrast, and transcripts for media.",
        icon: "tabler:eye",
      },
      {
        title: "Outcome",
        description:
          "A structured approach built a strong digital presence, ready for relaunch after relocation.",
        icon: "tabler:rocket",
      },
    ],
    faqs: [
      {
        ...
        description:
          "Creating a website that effectively targeted two distinct audiences: performance clients and students.",
      },
      {
        title: "What intercultural challenges did you face?",
        description:
          "Julio mostly spoke in Spanish, so Isabella helped with translation to ensure clear communication.",
      },
      {
        title: "What further improvements can be made?",
        description:
          "Enhancing accessibility: screen reader compatibility, color contrast, and transcripts for audio/video content.",
      },
      {
        title: "What was the outcome of the project?",
        description:
          "A comprehensive plan and blueprint for Julio's digital presence, ready to be relaunched in his new location.",
      },
    ],
  },
  {
    ...
    title: "OBI Chatbot",
    description:
      "We made OBI's brand friendlier and added a chatbot that helps people find what they need and answers questions online.",
    ...
    hero: {
      ...
      image: {
        src: "/assets/images/Timo-home-hero.png",
        alt: "Timo Tüftler OBI chatbot hero image",
      },
    },
    features: [
      {
    ...
    insights: [
      ...
      {
        title: "Frameworks Shaped the Concept",
        description:
      ...
      {
        title: "Service Design Understanding",
        description:
    ...
    faqs: [
      {
        title: "What was the main goal of the OBI Chatbot project?",
        description:
      ...
      {
        title: "What did collaboration teach the team?",
        description:
