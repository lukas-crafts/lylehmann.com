...
const APP_BLOG = {
  ...
  postsPerPage: 10,
  list: { pathname: "blog", isEnabled: true, robots: "index,follow" },
  category: { pathname: "category", isEnabled: true, robots: "index,follow" },
  tag: { pathname: "tag", isEnabled: true, robots: "index,follow" },
  post: { permalink: "blog/%slug%", isEnabled: true, robots: "index,follow" },
};
...
const load = async (): Promise<Array<Post>> => {
  // Holt alle Einträge aus der Collection 'post' gemäß Content v7
